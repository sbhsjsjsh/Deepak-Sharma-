      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-10">
        <div className="bg-slate-900 text-white rounded-3xl p-8 sm:p-12 lg:p-14 relative overflow-hidden shadow-lg">
          ...
          <div className="relative max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-orange-400 text-xs sm:text-sm font-medium mb-4">
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs sm:text-sm text-slate-300">
              ...
              <a
                ...
                className="flex items-center gap-2 bg-orange-600 hover:bg-orange-500 px-3.5 py-2 rounded-lg text-white font-semibold shadow-sm transition-colors"
              >
